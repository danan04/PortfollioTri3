...
public class CircleQueue
{
    ...
    public void selectionSort() {   
        ...
        while (node2 != null) { 
            ...
            String keyText = node1.getObject().toString();
            LinkedList key = node1;
            ...
            while ( slot2 != null) {
                ...
                if (slot2.getObject().toString().compareTo(keyText) < 0)
                {
                    //key.setObject(slot2.getObject());
                    keyText = slot2.getObject().toString();
                    key = slot2;
                }
                //slot2.setObject(slot1.getObject());
            ...
            if (slot1.getObject().toString().compareTo(keyText) != 0)
            {
                ...
                Object temp = key.getObject();
                //LinkedList temp = new LinkedList(key);
                key.setObject(slot1.getObject());
                slot1.setObject(temp);
            }
